...
public class TestCode {
    ...
    public static BufferedImage drawLogoQRCode(File logoFile, File codeFile, String qrUrl, String note) {
        try {
            ...
            boolean delete = codeFile.delete();
            if (delete){
    ...
    public static void main(String[] args) {
        File logoFile = new File("C:\\Users\\windows\\Desktop\\1.jpg"); //logo
        File QrCodeFile = new File("C:\\Users\\windows\\Desktop\\b.png");
        String url = "https://www.baidu.com/";
        String note = "*******会议哈哈哈111111111111";
        TestCode.drawLogoQRCode(logoFile, QrCodeFile, url, note);
    }
}
